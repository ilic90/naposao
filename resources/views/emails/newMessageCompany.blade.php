                                ...
                                <td align="left" valign="top">
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                           <a href="" style="color: #ff5b5c;">{{ $user->first_name }} {{ $user->last_name }}</a>, you have received a message from <a href="" style="color: #ff5b5c;">Vladimir Arsenijevic</a> regarding the ad - <a href="" style="color: #ff5b5c;">General things manager</a>.
                                         </span>
                                    </font>
