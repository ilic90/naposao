...
<table cellspacing=0 cellpadding=0 border=0 class="cvTable" align=center>
			...
			<table cellspacing=0 cellpadding=0 border=0 width=100%>
				...
				<tr>
					<td align=right valign=top style="padding-left:400px;">
...
<table cellspacing=0 cellpadding=0 border=0 class="cvTable" align=center>
	...
	<tr>
		<td colspan=2 align=center style="padding-top:20px;"><img alt="" src="{{ URL::to('/public')}}/photos/naposaologo.png"></td>
	</tr>
</table>
</body>
</html>