...
@section('content')
<h1 class="page_title main_page_title">{{ __('translate.companies_create_premium_ad_h1') }}</h1>
...
@include('layouts.errors')
	<form action="{{ route('postNewJob') }}" method="POST" class="new_job_add_choose_form">
		...
		<div class="new_job_add_choose_form_item">
			<p class="form_title">{{ __('translate.companies_create_ad_confidential') }}</p>
...
{{-- 		<div class="new_job_add_choose_form_item">
		...
		<div class="new_job_add_choose_form_item">
			...
			<input name="ad_type" type="hidden" value="4">
